...
<form id="form2" name="form2" method="post" action="salir.php">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="440">
		...
		<td class="bodyText"><p>&nbsp;</p>
		  <form id="form2" name="form2" method="post" action="crear_usuarios.php">
		    <label>
		    <div align="center">
		  ...
		  <form id="form3" name="form3" method="post" action="listar_usuarios.php">
		    <label>
		    <div align="center">
		      <input type="submit" name="editar" id="editar" value="Listar Usuario" />
		      <br />
		      <br />
		    </div>
		    </label>
		    </form>
		  <form id="form4" name="form4" method="post" action="editar_usuarios.php">
		    <label>
		      <div align="center">
		        <input type="submit" name="listar" id="listar" value="Editar Usuarios" />
	            <br />
	            <br />
		      </div>
		    </label>
