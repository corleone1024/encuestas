...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="230">
		<tr>
		<td width="230" class="sidebarText" id="padding"><form id="form2" name="form2" method="post" action="editar_usuarios.php">
		  <div align="center">
		    <input type="submit" name="atras11" id="atras11" value="Atras" />
		    </div>
		</form>		  
		  <div align="center"><br />
	      </div></td>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="440">
		<tr>
		<td class="pageName"><p align="center">Realice modifiaciones</p></td>
		</tr>
...
<form name="form1" action="insertaredicionusuario.php" method="get">
          <table width="306" border="1" class='CSSTableGenerator'>
            ...
            <tr>
              ...
              <td><label>
                <input type="password" name="txtpass" id="txtpass" required="required">
              </label></td>
            </tr>
            <tr>
              <td>Nivel;</td>
