...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="230">
		...
		<td width="230" class="sidebarText" id="padding"><form id="form2" name="form2" method="post" action="usuarios.php">
		  <label>
		    <div align="center">
		      <input type="submit" name="atras3" id="atras3" value="Atras" />
		    </div>
		  </label>
		  </form>
		<br />
	...
	<table border="0" cellspacing="0" cellpadding="0" width="440">
        ...
        <form action="editarusuario.php" method="get" >
					...
					$res=mysql_query("select * from usuario") or die("error en tb usuarios");
				
									 
									 
					$tabla = "<table border=1>\n";
					$tabla .= "<tr><td>login Usuario</td><td>Nivel</td><td>Estado</td><td>Editar</td><td>Deshabilitar</td></tr>\n";
					...
					$tabla .= "<tr>
					       ...
					       <td>".$fila["nivel"]."</td>
						   <td>".$fila["estado"]."</td>
						   <td><a href='editarusuarios.php?usuario=$fila[login]'>Editar</a></td>
						   <td><a href='deshabilitar_usuarios.php?usuario=$fila[login]'>Deshabilitar</a></td>
					      </tr>\n";
					}
					//Se cierra la tabla
					$tabla .= "</table>\n";
